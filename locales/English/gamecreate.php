...
<div class="content content-follow-on">
        ...
        <form method="post">
            ...
            <div id="betModal" class="modal">
                ...
                <div class="modal-content">
                    ...
                    <p><strong>Bet:</strong> </br>
                        The bet required to join this game. This is the amount of points that all players, including
                        you,
            ...
            <div id="phaseLengthModal" class="modal">
                ...
                <div class="modal-content">
                    ...
                    <p><strong>Phase Length: </strong></br>
                        How long each phase of the game will last in hours. Longer phase hours means a slow game with
                        more time to talk.
            ...
            <div id="variantModal" class="modal">
                ...
                <div class="modal-content">
                    ...
                    <p><strong>Variant:</strong> </br>
                        Type of Diplomacy game from a selection of maps and alternate rule settings available. Click any
                        of the variant names to view the details on the variants page.
                        <br /><br />
						...
						?>
                        <br />
                        *Please note that 1 vs 1 games will default to a 5 point bet as an unranked game no matter what
                        bet/game type are selected.
                    </p>
                </div>
            </div>
			...
			?>
                ...
                <div id="scoringModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <p><strong>Scoring:</strong> </br>
                            ...
                            In Draw-Size Scoring, the pot is split equally between the remaining players when the game
                            draws (this setting used to be called WTA).
                            <br /><br />
                            In Sum-of-Squares scoring, the pot is divided depending on how many centers you control when
                            the game draws.
                            <br /><br />
                            In both Draw-Size Scoring and Sum-of-Squares, any solo winner receieves the whole pot.
                            <br /><br />
                            Unranked games have no effect on your points at the end of the game; your bet is refunded
                            whether you won, drew or lost.
                        </p>
                    </div>
                </div>
                <select class="gameCreate" name="newGame[potType]">
                    <option name="newGame[potType]" value="Winner-takes-all" selected>DSS (Equal split for draws)
                    </option>
                ...
                <div id="anonModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <p><strong>Anonymous players: </strong></br>
                            Decide if player names should be shown or hidden.</br></br> *Please note that games with no
                            messaging are always anonymous regardless of what is set here to prevent cheating.
                        </p>
                    </div>
                </div>
                ...
                <p>
                    ...
                    <input id="minRating" class="gameCreate" type="text" name="newGame[minimumReliabilityRating]"
                        size="2" value="<?php print $defaultRR ?>"
                        onkeypress="if (event.keyCode==13) this.blur(); return event.keyCode!=13" onChange="
                ...
                <div id="delayModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <p><strong>Excused delays per player:</strong></br>
                            ...
                            The game will only progress with missing orders if no replacement is found within one phase
                            of a player being forced into Civil Disorder.
                            Set this value low to prevent delays to your game, set it higher to be more forgiving to
                            people who might need occasional delays.
                        </p>
                    </div>
                </div>
			...
			?>
                ...
                <p>
                    ...
                    <input class="gameCreate" type="password" autocomplete="new-password" name="newGame[password]"
                        value="" size="20" id="password"/></br>
                    Confirm: <input class="gameCreate" autocomplete="new-password" type="password"
                        name="newGame[passwordcheck]" value="" size="20" id="passwordCheck"/></br>
                </p>
                <p>
    ...
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.min.js" type="text/javascript" charset="utf-8">
    </script>
    ...
    // When the user tries to add people to be invited
    $(function() {
        var availableTags =
            <?php
            global $DB;
            echo(json_encode($DB->sql_all("SELECT username FROM wD_Users 
            WHERE type NOT LIKE'%Banned%' AND type NOT LIKE '%Guest%' AND type NOT LIKE '%System%'
